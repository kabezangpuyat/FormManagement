                    ...
                    <td>
                      <table class="flextable" style="width:60%">
                        <thead>
                            ...
                            <tr v-for="child in data.choices" :key="child.id" >
                              <td  style="width:90%;" v-if="data.isnew==true">{{child.name}}</td>
                              <td  style="width:90%;" v-else><input type="text" v-model="child.name" /></td>
                              <td v-if="data.isnew==true">{{child.value}}</td>
                              <td v-else><input type="number" v-model="child.value" /></td>
                            </tr>
                        </thead>
                      </table>
                    </td>
        ...
        .then(d => {
            setTimeout(() => {
              ...
              if(searchData.length>0){
                ...
                let createformurl = commonservice.getApiHost('/api/Form/update-multiplechoice-form');
