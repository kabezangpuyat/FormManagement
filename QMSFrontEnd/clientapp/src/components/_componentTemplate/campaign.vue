<template>
    <div class="content" >        
        ...
        <campaignform v-if="showForm" @hidechild="hidechild" v-bind:data="this.campaign"></campaignform>
...
<script>
    ...
    import campaignform from "@/components/admin/admin_components/campaign-form.vue";
    export default {
        name: 'CampaignManagement',
        components: { headertitle,campaignform },
        data() {
            return {
        ...
        methods: {
            ...
            async remove(dialog,id){
                if(id>0){
                    await axios.put('/api/campaign/update/' + id);
                    this.getAllCampaigns();
