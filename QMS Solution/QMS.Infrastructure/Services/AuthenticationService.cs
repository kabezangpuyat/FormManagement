...
namespace QMS.Infrastructure.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public JWTResponse Authenticate(UserViewModel model, string ipAddress)
        {
            ...
            return new JWTResponse(model, jwtToken, refreshToken.Token, refreshToken.Expires, refreshToken, model.Roles, model.Campaigns);
        }
        ...
        private string GenerateJwtToken(UserViewModel user)
        {
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                Subject = new ClaimsIdentity(new Claim[]
                {
                    ...
                    new Claim(ClaimsContants.CurrentCampaigns,JsonSerializer.Serialize(user.Campaigns, DefaultSerializerOptions()))
                }),
                Expires = DateTime.Now.AddHours(1),
