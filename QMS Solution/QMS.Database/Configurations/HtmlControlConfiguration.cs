...
{
    public class HtmlControlConfiguration : IEntityTypeConfiguration<HtmlControl>
    {
        public void Configure(EntityTypeBuilder<HtmlControl> builder)
        {
            builder.ToTable("HtmlControl", schema: "dbo").HasKey(x => x.ID);
