...
namespace QMS.Queries.Form
{
    ...
    /// </summary>
    public static class GetAllActiveForm
    {
        #region Query
        ...
        #region Handler
        public class GetAllActiveFormHandler : QueryHandler, IRequestHandler<Query, ICommandQueryResponse>
        {
            public GetAllActiveFormHandler(IDataContext dataContext,
                IMapper mapper,
            ...
            {
                var data = _dataContext.Form.Where(x => x.Active)
                    .AsQueryable();
